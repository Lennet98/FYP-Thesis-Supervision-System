...
<?php include('includes/logics/materials_retrieval.php'); ?>
<!DOCTYPE html>
<html>
    <head>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<title>ThesisSupervision : Materials</title>
            ...
            <div class="thesis-content" style="border: none; margin: 0 auto; width: 100%;">
                ...
                <?php if(sizeof($posts) == 0) { ?>
                    <div style="border: 1px solid; border-top: none; padding: 20px 35px;">   
                        <p>No documents uploaded by supervisors found.</p>
                    </div>
                <?php } else { ?>
                    <?php $count = 1 ?>
                        ...
                        <div class="announcement_content" style="border-top:none;">
                            ...
                            <div class="mg-thesis-option">  
                                <a href="<?php echo $row['doc_path'] ?>" download>
                                    <button class="btn" name="edit_doc" style="width: 90%; float:none;">Download</button>
                                </a>
                            </div>
                            <?php $count += 1 ?>
                        </div>
