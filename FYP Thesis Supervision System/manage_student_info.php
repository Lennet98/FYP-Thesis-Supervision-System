<?php include('includes/logics/student_profile_retrieval.php'); ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<title>ThesisSupervision : <?php echo $student_name?>'s Profile</title>
	...
	<body>
		...
		<div class="profile-content" style="margin-bottom:30px;">
		    <?php if (isset($_SESSION['success'])) : ?>
				<div class="error success" style="margin-top: 0; width:90%;">
					<h3>
						<?php 
    		...
    		<div class="input-group">
			    ...
			    <form method="post" action="manage_student_info.php" style="all:initial;">
    			    <p><strong>Thesis Title:</strong></p>
        			    <input type="text" name="thesis_title" id="thesis_title" value="<?php echo $dis_thesis; ?>" style="margin-right: 10px; width:85%"/>
        			    <button type="submit" class="btn" name="edit_thesis_title" style="font-size: 0.9vw; display: inline; float:none;">Edit</button>
			    </form>
